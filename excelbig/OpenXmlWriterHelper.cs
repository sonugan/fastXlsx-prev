...
namespace excelbig
{
    public class OpenXmlWriterHelper
    {
        ...
        virtual public void SaveCustomStylesheet(WorkbookPart workbookPart)
        {
            ...
            fill.PatternFill = patternFill;
            fills.AppendChild(fill);
            fills.AppendChild(new Fill() { PatternFill = new PatternFill() { PatternType = PatternValues.Solid, ForegroundColor = new ForegroundColor() { Rgb = HexBinaryValue.FromString("bb4055") } } });
            fills.Count = (uint)fills.ChildElements.Count;
            ...
            cf = new CellFormat();// Header format is defined as StyleINdex = 3
            cf.NumberFormatId = 0;
            cf.FontId = 0;
            cf.FillId = 3;
            cf.ApplyFill = true;
